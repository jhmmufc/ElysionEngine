...
namespace ElysionEngine
{
    ...
    public:
        ...
        /**
         * \brief Construct a colour from a Vector3
         * \param vector A Vector3 containing RBG components in its XYZ components.
         */
        explicit constexpr Colour(const Vector3& vector) noexcept
            : Colour(vector.x, vector.y, vector.z)
        {}

        /**
         * \brief Construct a colour from a Vector4
         * \param vector A Vector4 containing RBGA components in its XYZW components.
         */
        explicit constexpr Colour(const Vector4& vector) noexcept
            : Colour(vector.x, vector.y, vector.z, vector.w)
        {}

        /**
         * \brief Convert this Colour to a Vector3, RGB = XYZ
         */
        ...
        /**
         * \brief Convert this Colour to a Vector4, RGBA = XYZW
         */
        ...
        constexpr Colour(const float r, const float g, const float b, const float a) noexcept
            : m_packed_colour(uint32_t(
                Maths::Util::normalised_float_to_byte(a) << 24) |
                Maths::Util::normalised_float_to_byte(r) << 16 |
                Maths::Util::normalised_float_to_byte(g) << 8 |
                Maths::Util::normalised_float_to_byte(b))
        {}
        ...
        static constexpr Colour lerp(const Colour& value1, const Colour& value2, float amount) noexcept
        {
            return
            {
                Maths::Util::normalised_float_to_byte(Maths::Util::lerp(value1.r(), value2.r(), amount)),
                Maths::Util::normalised_float_to_byte(Maths::Util::lerp(value1.g(), value2.g(), amount)),
                Maths::Util::normalised_float_to_byte(Maths::Util::lerp(value1.b(), value2.b(), amount)),
                Maths::Util::normalised_float_to_byte(Maths::Util::lerp(value1.a(), value2.a(), amount))
            };
        }
    ...
    inline std::ostream& operator << (std::ostream& lhs, const Colour& rhs) noexcept
    {
